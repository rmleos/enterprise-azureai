...
param resourceGroupName string = 'IET-AggieCloud-OpenAI-API-Dev'
param openAiServiceName string = 'AggieAI-Dev'
param apimIdentityName string = 'APIM-AggieAI'
param proxyIdentityName string = 'Prox-AggieAI'
param deploymentScriptIdentityName string = ''
param apimServiceName string = 'APIM-AggieAI'
param logAnalyticsName string = 'LA-AggieAI'
param dataCollectionEndpointName string = ''
param dataCollectionRuleName string = ''
param applicationInsightsDashboardName string = 'AggieAI OpenAI Token Usage'
param applicationInsightsName string = 'AggieAI-AppInsights'
param proxyAppName string = 'ProxApp-AggieAI'
param vnetName string = 'AZURE-VDI-1-172_30_16_0'
param apimSubnetName string = 'subnet-APIM-AggieAI'
param apimNsgName string = 'NSG-APIM-AggieAI'
param acaSubnetName string = 'subnet-ContainerApp-AggieAI'
param acaNsgName string = 'NSG-ContainerApp-AggieAI'
param privateEndpointSubnetName string = ''
param privateEndpointNsgName string = ''
param redisCacheServiceName string = ''
param containerRegistryName string = ''
param containerAppsEnvironmentName string = 'CAE-AggieAI'
